...
import random
import re
from product.utils import init_logger
...
def update_ip_pool_logic(spider_name, link, logger):
    ...
    while True:
        try:
            ...
            url = "http://ttvp.daxiangip.com/ip/?tid=559436287116377&delay=1&category=2&foreign=none&ports=80,8080&num=20"
            ...
            print 'len(ips): %d' % len(ips)
            logger.info('len(ips): %d' % len(ips))
...
if __name__  == "__main__":
    ...
    """
        help info:
            ...
            python update_ip_pool.py hc360 http://www.hc360.com/
